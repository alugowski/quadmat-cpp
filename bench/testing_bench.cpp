...
BENCHMARK_CAPTURE(BM_Multiply, square_ER_14, std::string("square ER scale 14"))->Apply(CommonArguments);

BENCHMARK_CAPTURE(BM_TripleProduct, submatrix_ER_14, std::string("submatrix ER scale 14"))->Apply(CommonArguments);
